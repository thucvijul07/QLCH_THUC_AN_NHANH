...
namespace QUAN_LY_CUA_HANG_THUC_AN_NHANH
{
    public partial class Frm_BA_CHI_TIET : Form
    {
        ...
        private void XEM_CSDL_THEO_ID(string ID_DATA)
        {
            ...
            data.MS_SQL_QUERY = "SELECT MA_BAN, TEN_BAN FROM BAN_AN WHERE (MA_BAN = @MA_BAN) ORDER BY MA_BAN ASC";
            data.MS_SQL_PARAMETERS = data.CREATE_MS_SQL_PARAMETERS();
            data.MS_SQL_PARAMETERS.Clear();
            data.MS_SQL_PARAMETERS.Rows.Add("@MA_BAN", ID_DATA, SqlDbType.VarChar);
        ...
        private void btn_them_Click(object sender, EventArgs e)
        {
            ...
            DataAccess data = new DataAccess();
            data.MS_SQL_CONNECTION_STRING = SQL_CONNECTION_STRING;
            data.MS_SQL_QUERY = "INSERT INTO BAN_AN (MA_BAN, TEN_BAN) VALUES (@MA_BAN, @TEN_BAN)";
            data.MS_SQL_PARAMETERS = data.CREATE_MS_SQL_PARAMETERS();
            data.MS_SQL_PARAMETERS.Clear();
            data.MS_SQL_PARAMETERS.Rows.Add("@MA_BAN", ma_ban, SqlDbType.VarChar);
            data.MS_SQL_PARAMETERS.Rows.Add("@TEN_BAN", ten_ban, SqlDbType.NVarChar);
        ...
        private void btn_capnhat_Click(object sender, EventArgs e)
        {
            ...
            DataAccess data = new DataAccess();
            data.MS_SQL_CONNECTION_STRING = SQL_CONNECTION_STRING;
            data.MS_SQL_QUERY = "UPDATE BAN_AN SET TEN_BAN = @TEN_BAN WHERE MA_BAN = @MA_BAN";
            data.MS_SQL_PARAMETERS = data.CREATE_MS_SQL_PARAMETERS();
            data.MS_SQL_PARAMETERS.Clear();
            data.MS_SQL_PARAMETERS.Rows.Add("@MA_BAN", ma_ban, SqlDbType.VarChar);
            data.MS_SQL_PARAMETERS.Rows.Add("@TEN_BAN", ten_ban, SqlDbType.NVarChar);
