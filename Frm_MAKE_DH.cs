...
namespace QUAN_LY_CUA_HANG_THUC_AN_NHANH
{
    public partial class Frm_MAKE_DH : Form
    {
        ...
        private void Make_Combobox_Ds_HH()
        {
            ...
            data.MS_SQL_QUERY = "SELECT MA_HH, TEN_HH FROM HANG_HOA ORDER BY MA_HH ASC";
        ...
        private int LAY_DON_GIA_THEO_MA_HH(string ma_hh = "")
        {
            ...
            if (ma_hh.Trim() != "")
            {
                DataAccess data = new DataAccess();
                data.MS_SQL_CONNECTION_STRING = SQL_CONNECTION_STRING;
                data.MS_SQL_QUERY = "SELECT DON_GIA FROM HANG_HOA WHERE MA_HH = @MA_HH";
                data.MS_SQL_PARAMETERS = data.CREATE_MS_SQL_PARAMETERS();
                data.MS_SQL_PARAMETERS.Clear();
                data.MS_SQL_PARAMETERS.Rows.Add("@MA_HH", ma_hh, SqlDbType.Int);
                ArrayList KQ = data.MS_SQL_SELECT();
        ...
        private int LAY_SO_LUONG_TON_THEO_MA_HH(string ma_hh)
        {
            ...
            if (ma_hh.Trim() != "")
            {
                DataAccess data = new DataAccess();
                data.MS_SQL_CONNECTION_STRING = SQL_CONNECTION_STRING;
                data.MS_SQL_QUERY = "SELECT SO_LUONG FROM HANG_HOA WHERE MA_HH = @MA_HH";
                data.MS_SQL_PARAMETERS = data.CREATE_MS_SQL_PARAMETERS();
                data.MS_SQL_PARAMETERS.Clear();
                data.MS_SQL_PARAMETERS.Rows.Add("@MA_HH", ma_hh, SqlDbType.Int);
                ArrayList KQ = data.MS_SQL_SELECT();
        ...
        private void btn_tao_dh_Click(object sender, EventArgs e)
        {
            ...
            if (ma_dh != 0)
            {
                ...
                for (int i = 0; i < DT_CHITIET.Rows.Count; i++)
                {
                    ...
                    DataAccess data = new DataAccess();
                    data.MS_SQL_CONNECTION_STRING = SQL_CONNECTION_STRING;
                    data.MS_SQL_QUERY = "INSERT INTO DON_HANG_CHI_TIET (MA_DH, MA_BAN, MA_HH, SO_LUONG, DON_GIA) VALUES (@MA_DH, @MA_BAN, @MA_HH, @SO_LUONG, @DON_GIA)";
                    data.MS_SQL_PARAMETERS = data.CREATE_MS_SQL_PARAMETERS();
                    data.MS_SQL_PARAMETERS.Clear();
                    data.MS_SQL_PARAMETERS.Rows.Add("@MA_DH", ma_dh, SqlDbType.Int);
                    data.MS_SQL_PARAMETERS.Rows.Add("@MA_BAN", ma_ban, SqlDbType.VarChar);
                    data.MS_SQL_PARAMETERS.Rows.Add("@MA_HH", ma_hh, SqlDbType.Int);
                    data.MS_SQL_PARAMETERS.Rows.Add("@SO_LUONG", so_luong, SqlDbType.Int);
                    data.MS_SQL_PARAMETERS.Rows.Add("@DON_GIA", don_gia, SqlDbType.Int);
        ...
        private void CAP_NHAT_SO_LUONG_TRONG_BANG_HANG_HOA_THEO_MA_HH(string ma_hh, string so_luong_can_giam)
        {
            DataAccess data = new DataAccess();
            data.MS_SQL_CONNECTION_STRING = SQL_CONNECTION_STRING;
            data.MS_SQL_QUERY = "UPDATE HANG_HOA SET SO_LUONG = SO_LUONG - @SO_LUONG_CAN_GIAM WHERE MA_HH = @MA_HH";
            data.MS_SQL_PARAMETERS = data.CREATE_MS_SQL_PARAMETERS();
            data.MS_SQL_PARAMETERS.Clear();
            data.MS_SQL_PARAMETERS.Rows.Add("@MA_HH", ma_hh, SqlDbType.Int);
            data.MS_SQL_PARAMETERS.Rows.Add("@SO_LUONG_CAN_GIAM", so_luong_can_giam, SqlDbType.Int);
            String[] KQ = data.MS_SQL_INSERT_DELETE_UPDATE();
        ...
        private void CAP_NHAT_THANH_TIEN_TRONG_BANG_DON_HANG_THEO_MA_DH(string ma_dh)
        {
            DataAccess data = new DataAccess();
            data.MS_SQL_CONNECTION_STRING = SQL_CONNECTION_STRING;
            data.MS_SQL_QUERY = "UPDATE DON_HANG SET THANH_TIEN = (SELECT SUM(THANH_TIEN) FROM DON_HANG_CHI_TIET WHERE MA_DH = @MA_DH) WHERE MA_DH = @MA_DH";
            data.MS_SQL_PARAMETERS = data.CREATE_MS_SQL_PARAMETERS();
            data.MS_SQL_PARAMETERS.Clear();
            data.MS_SQL_PARAMETERS.Rows.Add("@MA_DH", ma_dh, SqlDbType.Int);
            String[] KQ = data.MS_SQL_INSERT_DELETE_UPDATE();
        ...
        private int TAO_MA_DON_HANG()
        {
            ...
            DataAccess data = new DataAccess();
            data.MS_SQL_CONNECTION_STRING = SQL_CONNECTION_STRING;
            data.MS_SQL_QUERY = "INSERT INTO DON_HANG (THANH_TIEN) OUTPUT INSERTED.MA_DH VALUES (@THANH_TIEN)";
            data.MS_SQL_PARAMETERS = data.CREATE_MS_SQL_PARAMETERS();
            data.MS_SQL_PARAMETERS.Clear();
            data.MS_SQL_PARAMETERS.Rows.Add("@THANH_TIEN", "0", SqlDbType.Int);

            String[] KQ = data.MS_SQL_INSERT_RETURN_OUTPUT();
        ...
        private void cbo_ds_hh_SelectedIndexChanged(object sender, EventArgs e)
        {
